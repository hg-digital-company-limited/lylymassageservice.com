                            ...
                            <div class="row" id="row-1243857379">
                                ...
                                <div id="col-131672577" class="col medium-6 small-12 large-6">
                                    <div class="col-inner text-left" data-parallax-fade="true" data-parallax="2">
                                        ...
                                        <p>Mang trong mình sứ mệnh xây dựng hệ thống spa chăm sóc sắc đẹp hàng đầu, đáp
                                            ứng
                                            nhu cầu làm đẹp và mong muốn có một không gian thư giãn, yên tĩnh trong môi
                                            trường tuyệt đối sạch sẽ, sau những giờ làm việc căng thẳng đang ngày càng
                                            đông.
                                        ...
                                        <p>Tự hào là đối tác chiến lược của tập đoàn <strong>AMITA GROUP</strong>, chúng
                                            ...
                                            triệu người trên khắp thế giới có chất lượng cuôc sống tốt hơn với 30 sản
                                            phẩm
                                    ...
                                    <div class="col-inner">
                                        ...
                                        <div class="tabbed-content">
                                            ...
                                            <ul class="nav nav-line nav-vertical nav-normal nav-size-normal nav-center active-on-hover"
                                                role="tablist">
                                                <li id="tab-766410314" class="tab active has-icon" role="presentation">
                                                    <a href="#tab_766410314" role="tab" aria-selected="true"
                                                ...
                                                <li id="tab-591670031" class="tab has-icon" role="presentation"><a
                                                        href="#tab_591670031" tabindex="-1" role="tab"
                                                        aria-selected="false"
                                                ...
                                                <li id="tab-878459757" class="tab has-icon" role="presentation"><a
                                                        href="#tab_878459757" tabindex="-1" role="tab"
                                                        aria-selected="false"
                                                ...
                                                <li id="tab-144812253" class="tab has-icon" role="presentation"><a
                                                        href="#tab_144812253" tabindex="-1" role="tab"
                                                        aria-selected="false"
                                                        aria-controls="tab_144812253"><span></span></a></li>
                                            </ul>
                                            <div class="tab-panels">
                                                <div id="tab_766410314" class="panel active entry-content"
                                                    role="tabpanel" aria-labelledby="tab-766410314">
                                                    <div class="box has-hover   has-hover box-text-bottom">
                                                        ...
                                                        <div class="box-text text-center">
                                                            <div class="box-text-inner">
                                                                ...
                                                                <p>Công nghệ nâng mũi độc quyền tại Thu Cúc, sử dụng sụn
                                                                    2
                                                                    lớp Bistool Softxil nhập khẩu chính hãng từ Hàn
                                                                    Quốc,
                                                    ...
                                                    <div class="box has-hover   has-hover box-text-bottom">
                                                        ...
                                                        <div class="box-text text-center">
                                                            <div class="box-text-inner">
                                                                ...
                                                                <h4>cắt mí</h4>
                                                                <p>Công nghệ được FDA Hoa Kỳ chứng nhận an toàn. Tại
                                                                    Việt
                                                                    Nam, Hệ thống thẩm mỹ Bệnh viện Thu Cúc là đơn vị
                                                                    nhận
                                                    ...
                                                    <div class="box has-hover   has-hover box-text-bottom">
                                                        ...
                                                        <div class="box-text text-center">
                                                            <div class="box-text-inner">
                                                                ...
                                                                <h4>Nâng ngực</h4>
                                                                <p>Công nghệ nâng ngực hiện đại bậc nhất được nhiều chị
                                                                    em
                                                    ...
                                                    <div class="box has-hover   has-hover box-text-bottom">
                                                        ...
                                                        <div class="box-text text-center">
                                                            <div class="box-text-inner">
                                                                ...
                                                                <h4>Hút mỡ</h4>
                                                                <p>Công nghệ hiện đại được các chuyên gia thẩm mỹ thế
                                                                    giới
                                                                    tin dùng, được FDA Hoa Kỳ chứng nhận an toàn cho sức
                                                                    khỏe người sử dụng và được công nhận trên toàn thế
                                                                    giới.
                                                                </p>
                                                                <a class="button primary nut-xem-them"
                                                                    style="border-radius:10px;">
                                    ...
                                    <div class="col-inner">
                                        ...
                                        <div class="tabbed-content">
                                            ...
                                            <ul class="nav nav-simple nav-uppercase nav-size-normal nav-left"
                                                role="tablist">
                                                <li id="tab-nâng-ngực" class="tab active has-icon" role="presentation">
                                                    <a href="#tab_nâng-ngực" role="tab" aria-selected="true"
                                                        aria-controls="tab_nâng-ngực"><span>Nâng ngực</span></a></li>
                                                <li id="tab-nâng-mũi" class="tab has-icon" role="presentation"><a
                                                        href="#tab_nâng-mũi" tabindex="-1" role="tab"
                                                        aria-selected="false" aria-controls="tab_nâng-mũi"><span>Nâng
                                                            mũi</span></a></li>
                                                <li id="tab-cắt-mí" class="tab has-icon" role="presentation"><a
                                                        href="#tab_cắt-mí" tabindex="-1" role="tab"
                                                        aria-selected="false" aria-controls="tab_cắt-mí"><span>Cắt
                                                            mí</span></a></li>
                                                <li id="tab-hút-mỡ" class="tab has-icon" role="presentation"><a
                                                        href="#tab_hút-mỡ" tabindex="-1" role="tab"
                                                        aria-selected="false" aria-controls="tab_hút-mỡ"><span>Hút
                                                            mỡ</span></a></li>
                                                <li id="tab-cấy-mỡ" class="tab has-icon" role="presentation"><a
                                                        href="#tab_cấy-mỡ" tabindex="-1" role="tab"
                                                        aria-selected="false" aria-controls="tab_cấy-mỡ"><span>Cấy
                                                            mỡ</span></a></li>
                                                ...
                                                <li id="tab-nâng-cơ-hifu" class="tab has-icon" role="presentation"><a
                                                        ...
                                                        aria-selected="false"
                                                        aria-controls="tab_nâng-cơ-hifu"><span>Nâng cơ
                                                            Hifu</span></a></li>
                                                <li id="tab-phun-xăm" class="tab has-icon" role="presentation"><a
                                                        href="#tab_phun-xăm" tabindex="-1" role="tab"
                                                        aria-selected="false" aria-controls="tab_phun-xăm"><span>Phun
                                                            xăm</span></a></li>
                                            </ul>
                                            <div class="tab-panels">
                                                <div id="tab_nâng-ngực" class="panel active entry-content"
                                                    role="tabpanel" aria-labelledby="tab-nâng-ngực">
                            ...
                            <div class="row row-small align-center row1" id="row-278796322">
                                <div id="col-626930822" class="col small-12 large-12">
                                    <div class="col-inner text-center">
                                        ...
                                        <p>“Reborn Tái sinh” là chương trình truyền hình thực tế về phẫu thuật thẩm mỹ
                                            do Hệ
                                            thống thẩm mỹ Bệnh viện Thu Cúc tổ chức với sự đồng hành của các chuyên gia,
                                            bác
                                            sĩ có trên 20 năm kinh nghiệm tạo hình thẩm mỹ và những người nổi tiếng hàng
                                            đầu
                                            tại Việt Nam. Chương trình tìm kiếm những thí sinh kém may mắn về ngoại hình
                                            để
                                            trao tấm vé phẫu thuật thẩm mỹ toàn diện miễn phí 100%, trị giá 1 tỷ
                                            đồng/suất
                            ...
                            <div class="row row-collapse row2" id="row-346733422">
                                <div id="col-298827640" class="col medium-3 small-6 large-3">
                                    <div class="col-inner">
                                        ...
                                        <div class="img has-hover mau-hien x md-x lg-x y md-y lg-y"
                                            id="image_613272857">
                                            <a class="" href="/">
                                                <div class="img-inner dark">
                            ...
                            <div class="row row-small row1" id="row-135384127">
                                <div id="col-1696064735" class="col cot8 medium-8 small-12 large-8">
                                    <div class="col-inner">
                                        ...
                                        <h2 class="title-all-home"><a>TIN TỨC NỔI BẬT</a></h2>
                                        <div class="row row-small row1-1" id="row-823116181">
                                            <div id="col-340770293" class="col medium-6 small-12 large-6">
                                                <div class="col-inner">
                                                    ...
                                                    <div
                                                        class="row post1 large-columns-1 medium-columns-1 small-columns-1">
                                                        <div class="col post-item">
                                                            <div class="col-inner">
                                                                @foreach ($get5postslastest as $post)
                                                                <div
                                            ...
                                            <div id="col-88599450" class="col medium-6 small-12 large-6">
                                                <div class="col-inner">
                                                    ...
                                                    <div
                                                        class="row post2 large-columns-1 medium-columns-1 small-columns-1">
                                                        @foreach ($get5postslastest1 as $post)
                                                                        ...
                                                                        <div class="image-cover"
                                                                            ...
                                                                            <a href="/dich-vu/{{ ($post->slug) }}"
                                                                                ...
                                                                                <img loading="lazy" decoding="async"
                                                                                    ...
                                                                                    class="attachment-original size-original wp-post-image"
                                                                                    alt=""
                                                                                    srcset="{{ Storage::url($post->banner) }} 1920w, {{ Storage::url($post->banner) }} 300w, {{ Storage::url($post->banner) }} 1024w, {{ Storage::url($post->banner) }} 768w, {{ Storage::url($post->banner) }} 1536w"
                                                                                    sizes="(max-width: 1920px) 100vw, 1920px" />
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                ...
                                <div id="col-314678550" class="col cot4 medium-4 small-12 large-4">
                                    <div class="col-inner">
                                        ...
                                        <h2 class="title-all-home"><a >HỎI ĐÁP THẨM MỸ</a></h2>


                                        <div class="row post-hoi-dap large-columns-1 medium-columns-1 small-columns-1">
                                            @foreach ($get5postslastest3 as $post)
                                            <div class="col post-item">
                                                <div class="col-inner">
                                        ...
                                        <h2 class="title-all-home"><a >TIN TỨC MỚI</a></h2>


                                        <div class="row post-hoi-dap large-columns-1 medium-columns-1 small-columns-1">
                                            @foreach ($get5postslastest2 as $post)
                                            <div class="col post-item">
                                                <div class="col-inner">
                                                    <div class="box box-normal box-text-bottom box-blog-post has-hover">
                                                        <div class="box-image">
                                                            <div class="image-cover" style="padding-top:0%;">
                                                                <a href="/dich-vu/{{ ($post->slug) }}"
                                                                    ...
                                                                    <img loading="lazy" decoding="async" width="300"
                                                                        ...
                                                                        class="attachment-medium size-medium wp-post-image"
                                                                        alt=""
                                                                        srcset="{{ Storage::url($post->banner) }} 300w, {{ Storage::url($post->banner) }} 600w"
                                                                        sizes="(max-width: 300px) 100vw, 300px" /> </a>
                                                            </div>
                                                        </div>
                                                        <div class="box-text text-left">
