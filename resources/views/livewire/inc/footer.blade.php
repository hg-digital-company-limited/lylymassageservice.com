    ...
    <section class="section footer-section dark" id="section_22949667">
            ...
            <div class="row" id="row-304338368">
                ...
                <div id="col-1834182212" class="col medium-4 small-12 large-4">
                    <div class="col-inner">
                        ...
                        <div class="social-icons follow-icons"><a href="http://url" target="_blank"
                                ...
                                class="icon primary button circle instagram tooltip" title="Theo dõi trên Instagram"
                                aria-label="Theo dõi trên Instagram" rel="noopener nofollow"><i
                                    class="icon-instagram"></i></a><a href="http://url" data-label="Twitter"
                                target="_blank" class="icon primary button circle twitter tooltip"
                                title="Theo dõi trên Twitter" aria-label="Theo dõi trên Twitter"
                                rel="noopener nofollow"><i class="icon-twitter"></i></a><a href="mailto:your@email"
                                data-label="E-mail" target="_blank" class="icon primary button circle email tooltip"
                ...
                <div id="col-662721862" class="col medium-4 small-12 large-4">
                    <div class="col-inner">
                        ...
                        <div class="container section-title-container">
                            <h4 class="section-title section-title-normal"><b></b><span class="section-title-main">dịch
                                    vụ nổi bật</span><b></b></h4>
                        </div>
                ...
                <div id="col-194654097" class="col medium-4 small-12 large-4">
                    <div class="col-inner">
                        ...
                        <div class="container section-title-container">
                            <h4 class="section-title section-title-normal"><b></b><span class="section-title-main">chỉ
                                    đường</span><b></b></h4>
                        </div>
        ...
        <style>
            ...
            #section_22949667 .section-bg.bg-loaded {
                background-image: url(/assets/wp-content/uploads/2020/10/bg-footer.jpg);
            }
        </style>
    </section>
