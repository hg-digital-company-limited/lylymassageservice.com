                    ...
                    <ul class="mobile-nav nav nav-right ">
                        <li class="header-search header-search-dropdown has-icon has-dropdown menu-item-has-children">
                            <div class="header-button"> <a href="#" aria-label="Search"
                                    class="icon button circle is-outline is-small"><i class="icon-search"></i></a>
                            </div>
                ...
                <div class="flex-col hide-for-medium flex-left">
                    <ul
                        ...
                        <li id="menu-item-819"
                            ...
                            <a href="/gioi-thieu" class="nav-top-link">Giới thiệu</a>
                        </li>
                        <li id="menu-item-734"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-734 menu-item-design-default">
                            <a href="/bang-gia/" class="nav-top-link">Bảng giá</a>
                        </li>
                        @foreach($categories as $category)
                            <li id="menu-item-577"
                                class="menu-item menu-item-type-taxonomy menu-item-object-category {{ $category->children && $category->children->count() > 0 ? 'menu-item-has-children' : '' }} menu-item-577 menu-item-design-default has-dropdown">
                                <a href="/danh-muc/{{ $category->slug }}/" class="nav-top-link" aria-expanded="false"
                                    aria-haspopup="menu">{{ $category->name }}<i class="icon-angle-down"></i></a>
                            ...
                            @else
                                {{-- <li id="menu-item-578"
                                    ...
                                    <a href="/danh-muc/{{ $category->slug }}/" class="nav-top-link">{{ $category->name }}</a>
                                </li> --}}
                            @endif
                        @endforeach
                        <li id="menu-item-734"
