<div>
    ...
    <body
        class="post-template-default single single-post postid-572 single-format-standard lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border">
                ...
                <div id="content" class="blog-wrapper blog-single page-wrapper">
                    ...
                    <div class="row row-large row-divided ">
                        ...
                        <div class="large-9 col">
                            ...
                            <article id="post-572"
                                class="post-572 post type-post status-publish format-standard has-post-thumbnail hentry category-tham-my-mat category-tham-my-mui">
                            ...
                            <div id="comments" class="comments-area">
                                ...
                                <div id="respond" class="comment-respond">
                                    <h3 id="reply-title" class="comment-reply-title">Trả lời <small><a rel="nofollow"
                                                id="cancel-comment-reply-link" href="/rut-chat-lieu-mui-la-gi/#respond"
                                                style="display:none;">Hủy</a></small></h3>
                                    <form action="/assets/wp-comments-post.php" method="post"
                                        id="commentform" class="comment-form" novalidate>
                                        <p class="comment-notes"><span id="email-notes">Email của bạn sẽ không được hiển
                                                thị công khai.</span> <span class="required-field-message">Các trường
                                                bắt buộc được đánh dấu <span class="required">*</span></span></p>
                                        ...
                                        <p class="comment-form-cookies-consent"><input id="wp-comment-cookies-consent"
                                                ...
                                                for="wp-comment-cookies-consent">Lưu tên của tôi, email, và trang web
                                                trong trình duyệt này cho lần bình luận kế tiếp của tôi.</label></p>
                                        <p class="form-submit"><input name="submit" type="submit" id="submit"
                                                class="submit" value="Phản hồi" /> <input type='hidden'
                                                name='comment_post_ID' value='572' id='comment_post_ID' />
                                        ...
                                        <ul id="menu-menu-dich-vu-noi-bat" class="menu">
                                            ...
                                            <li id="menu-item-729"
                                                ...
                                                <a
                                                    ...
                                                    khắc lông mày hỏng có sửa được không?</a>
                                            </li>
                                            <li id="menu-item-730"
                                            ...
                                            <li id="menu-item-732"
                                                ...
                                                <a
                                                    ...
                                                    môi collagen giá bao nhiêu tiền 1 lần?</a>
                                            </li>
                                            <li id="menu-item-733"
        ...
        <script type="text/javascript" src="/assets/wp-includes/js/comment-reply.min.js?ver=6.4.3"
